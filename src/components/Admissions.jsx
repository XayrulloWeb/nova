    ...
    <section className="pb-[160px] px-margin-mobile md:px-margin-desktop max-w-[1920px] mx-auto" id="admissions" ref={containerRef}>
      <div className="md:w-8/12 mx-auto">
        <div className="mb-24 md:text-center">
          ...
          <p className="font-body-lg text-body-lg text-on-surface-variant">Maktabimizga o'quvchilarni qabul qilish ochiq, shaffof va adolatli tarzda amalga oshiriladi.</p>
        </div>
          ...
          <div className="space-y-24 relative">
            ...
            <div className="relative flex flex-col md:flex-row items-center justify-between group">
              <div className="hidden md:block md:w-[45%] text-right pr-12 relative">
                ...
                <p className="font-body-md text-body-md text-on-surface-variant">Bolaning ma'lumotlari va ota-onaning arizasini onlayn shaklda yuboring.</p>
              </div>
            ...
            <div className="relative flex flex-col md:flex-row items-center justify-between group">
              <div className="w-full pl-20 md:pl-0 md:w-[45%] md:text-right pr-12 relative overflow-hidden">
                ...
                <div className="md:hidden">
                  ...
                  <p className="font-body-md text-body-md text-on-surface-variant">Bolaning bilim darajasi va psixologik tayyorgarligini aniqlash uchun yoshiga mos suhbat va test sinovlari.</p>
                </div>
              </div>
              <div className="absolute left-8 md:left-1/2 -translate-x-1/2 w-4 h-4 rounded-full bg-surface border-2 border-primary-container z-10 timeline-connector transition-all duration-300 group-hover:scale-150 group-hover:bg-primary-container shadow-[0_0_15px_rgba(0,240,255,0.6)]"></div>
            ...
            <div className="relative flex flex-col md:flex-row items-center justify-between group">
              <div className="hidden md:block md:w-[45%] text-right pr-12 relative">
                ...
                <p className="font-body-md text-body-md text-on-surface-variant">Maktab rahbariyati bilan uchrashuv. Farzandingizning kelajagi va ta'lim maqsadlarini birgalikda belgilaymiz.</p>
              </div>
              <div className="absolute left-8 md:left-1/2 -translate-x-1/2 w-4 h-4 rounded-full bg-surface border-2 border-primary-container z-10 timeline-connector transition-all duration-300 group-hover:scale-150 group-hover:bg-primary-container shadow-[0_0_15px_rgba(0,240,255,0.6)]"></div>
              <div className="w-full pl-20 md:pl-0 md:w-[45%] md:text-left md:pl-12 relative overflow-hidden">
            ...
            <div className="relative flex flex-col md:flex-row items-center justify-between group">
              <div className="w-full pl-20 md:pl-0 md:w-[45%] md:text-right pr-12 relative overflow-hidden">
                ...
                <div className="md:hidden">
                  <h3 className="font-headline-md text-headline-md text-on-surface mb-2">Shartnoma va Qabul</h3>
                  <p className="font-body-md text-body-md text-on-surface-variant">Hujjatlarni rasmiylashtirish va NOVA xususiy maktabining katta oilasiga rasman qo'shilish.</p>
                </div>
              </div>
              <div className="absolute left-8 md:left-1/2 -translate-x-1/2 w-4 h-4 rounded-full bg-surface border-2 border-primary-container z-10 timeline-connector transition-all duration-300 group-hover:scale-150 group-hover:bg-primary-container shadow-[0_0_15px_rgba(0,240,255,0.6)]"></div>
              <div className="hidden md:block md:w-[45%] text-left pl-12 relative">
