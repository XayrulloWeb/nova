        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 lg:gap-8 mb-20">
          ...
          <div className="col-span-1 md:col-span-8 lg:col-span-3">
            ...
            <div className="flex gap-4">
              ...
              <a href="https://www.instagram.com/nova_maktab?igsh=MWZ6YjZtcmI4czd2ag==" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-surface-container border border-outline/10 flex items-center justify-center text-on-surface-variant hover:bg-primary hover:text-on-primary hover:border-primary transition-all duration-300">
